...
module.exports = function module (moduleOptions) {
  ...
  if (this.options.sitemap) this.options.sitemap = Array.isArray(this.options.sitemap) ? Array.from(this.options.sitemap) : [this.options.sitemap];

  for (var i = 0; i < this.options.sitemap.length; i++) {
    const options = {
      ...defaults,
      ...this.options.sitemap[i],
      ...moduleOptions
    }
